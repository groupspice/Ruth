...
FlipBook.prototype = {
	...
	,removeBookmark: function(pageNum) {
		...
		while(_g1 < _g) {
			var i1 = _g1++;
			haxe.Log.trace(RunTime.book.bookmarks[i1].pageNum,{ fileName : "FlipBook.hx", lineNumber : 2193, className : "FlipBook", methodName : "removeBookmark"});
	...
	,onTouchMove: function(e) {
		...
		if(this.zoomStatus == core.ZoomStatus.zoomed && this.startMoveGesture) {
			...
			haxe.Log.trace(this.zoom.style.cssText,{ fileName : "FlipBook.hx", lineNumber : 1645, className : "FlipBook", methodName : "onTouchMove"});
	...
	,pointDown: function(e) {
		var obj = e;
		haxe.Log.trace("pointDown",{ fileName : "FlipBook.hx", lineNumber : 492, className : "FlipBook", methodName : "pointDown"});
	...
	,attachActions: function() {
		...
		if(this.isTouch) this.maskGesture.target = eval("document.getElementById('mask')");
		if(this.isTouch) {
			...
			if(ad != null) {
				...
				if(isHtmlAD) {
					...
					if(this.mainAdLayout == "center") {
						...
						this.mainAdImg.style.height = this.mainAdHtml.style.maxHeight;
						this.mainAdImg.style.width = this.mainAdHtml.style.maxWidth;
...
RunTime.msOnResize = function(e) {
	if(js.Lib.document.body.clientHeight == js.Lib.window.screen.height && js.Lib.document.body.clientWidth == js.Lib.window.screen.width) {
		haxe.Log.trace("fullscreen",{ fileName : "RunTime.hx", lineNumber : 196, className : "RunTime", methodName : "msOnResize"});
		if(RunTime.resizeTimer != null) RunTime.resizeTimer.stop();
		RunTime.isFullscreen = true;
	} else {
		haxe.Log.trace("exit fullscreen",{ fileName : "RunTime.hx", lineNumber : 203, className : "RunTime", methodName : "msOnResize"});
...
RunTime.onFullscreenChange = function(e) {
	var obj = e;
	haxe.Log.trace(e,{ fileName : "RunTime.hx", lineNumber : 215, className : "RunTime", methodName : "onFullscreenChange"});
}
	...
	click: function(popupXOffset,popupYOffset) {
		...
		case "image":
			...
			core.HtmlHelper.toPopupImageHtml(this,function(txt) {
				...
				timer.run = function() {
					haxe.Log.trace("zoomComplete",{ fileName : "ButtonInfo.hx", lineNumber : 245, className : "core.ButtonInfo", methodName : "click"});
					timer.stop();
		...
		case "video":
			...
			var timer = new haxe.Timer(100);
			timer.run = function() {
				haxe.Log.trace("zoomComplete",{ fileName : "ButtonInfo.hx", lineNumber : 261, className : "core.ButtonInfo", methodName : "click"});
				timer.stop();
		...
		case "message":
			...
			var timer = new haxe.Timer(100);
			timer.run = function() {
				haxe.Log.trace("zoomComplete",{ fileName : "ButtonInfo.hx", lineNumber : 279, className : "core.ButtonInfo", methodName : "click"});
				timer.stop();
		...
		case "message-hover":
			...
			var timer = new haxe.Timer(100);
			timer.run = function() {
				haxe.Log.trace("zoomComplete",{ fileName : "ButtonInfo.hx", lineNumber : 290, className : "core.ButtonInfo", methodName : "click"});
				timer.stop();
				js.Lib.document.getElementById("popupMessage").style.cssText += " transform: scale(1);transition:all 500ms; -ms-transform: scale(1);-ms-transition: all 500ms;";
			};
			break;
...
core.HtmlHelper.toPopupImageHtml = function(item,success) {
	...
	if(item.popupWidth != null && item.popupHeight != null) {
		...
		s += "</div>";
		haxe.Log.trace(s,{ fileName : "HtmlHelper.hx", lineNumber : 469, className : "core.HtmlHelper", methodName : "toPopupImageHtml"});
	} else {
		s = "";
